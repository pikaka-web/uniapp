...
Z([3,'animated   bg-danger'])
Z([3,'bounceInLeft'])
Z([3,'width:40rpxx;height:80rpx;'])
...
var x=['./components/myIcon.wxml','./pages/index/index.wxml'];d_[x[0]]={}
...
_(oD,fE)
var cF=_mz(z,'view',['class',2,'hoverClass',1,'style',2],[],e,s,gg)
_(oD,cF)
_(r,oD)
return r
}
