...
var x=['./components/myIcon.wxml','./components/rotationChart.wxml','./components/searchBox.wxml','./pages/collection/collection.wxml','./pages/index/index.wxml','./pages/mine/mine.wxml','./pages/sort/sort.wxml'];d_[x[0]]={}
...
var fE=_mz(z,'swiper',['autoplay',-1,'circular',-1,'indicatorDots',-1,'bindchange',1,'data-event-opts',1,'indicatorActiveColor',2,'style',3],[],e,s,gg)
var cF=_v()
_(fE,cF)
...
var oP=_mz(z,'my-icon',['bind:__l',2,'class',1,'iconColor',2,'iconId',3,'iconSize',4,'vueId',5],[],e,s,gg)
_(bO,oP)
var xQ=_mz(z,'input',['class',8,'placeholder',1,'type',2],[],e,s,gg)
_(bO,xQ)
_(r,bO)
return r
}
...
var cW=_n('view')
_rz(z,cW,'style',1,e,s,gg)
_(oV,cW)
var oX=_mz(z,'search-box',['bind:__l',2,'vueId',1],[],e,s,gg)
_(oV,oX)
var lY=_mz(z,'rotation-chart',['bind:__l',4,'imgArr',1,'vueId',2],[],e,s,gg)
_(oV,lY)
_(r,oV)
return r
}
...
__wxAppCode__['pages/sort/sort.wxss']=undefined;    
